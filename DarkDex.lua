-- This source is from KRNL code
-- DnSpy: krnlss > krnlss.exe > krnlss > krnl > function: toolStripMenuItem2

-- Credits to KRNL.ca (Their exploit reversed and uploaded the script)
-- Credits to the original author of the code to who ever created it
